...
const sections: Array<[string, string, BackofficeCapability | null]> = [
  ...
  ["到貨驗收", "/admin/purchase-orders?filter=receivable", "procurement"],
  ["庫存", "/admin/inventory", "inventory"], ["入庫紀錄", "/admin/inventory?view=movements#inventory-movements", "inventory"],
  ["訂單", "/admin/orders", "orders"], ["顧客管理", "/admin/customers", "customers"],
