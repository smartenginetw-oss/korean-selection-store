...
import { CouponTypeSelect } from "./coupon-type-select";
...
export default async function AdminCouponsPage({ searchParams }: { searchParams: Promise<{ status?: string; message?: string }> }) {
  ...
  return <>
    <div className={adminStyles.titleRow}><div><div className="eyebrow">成長・老闆工具</div><h1 className="serif">優惠碼管理</h1></div><span className="badge badge-stock">伺服器驗證</span></div>
