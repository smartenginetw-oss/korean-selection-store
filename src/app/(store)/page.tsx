...
export default async function HomePage() {
  ...
  return <>
    ...
    <section className="section"><div className={`container ${styles.story}`}><div className={styles.storyArt}><span>01</span><span>SELECTED<br />WITH CALM</span></div><div className={styles.storyCopy}><div className="eyebrow">Our selection</div><h2 className="section-title serif">我們相信，質感不需要大聲說話。</h2><p>每一件選品都從版型、觸感與日常搭配開始思考。不追逐短暫熱度，只留下真正想反覆穿著與使用的東西。</p><Link className="button button-secondary" href="/about">認識 MORII</Link></div></div></section>
