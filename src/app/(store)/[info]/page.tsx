...
const pages: Record<string, { title: string; body: string }> = {
  about: { title: "關於 MORII", body: "我們從版型、觸感與日常搭配出發，選擇能長久陪伴生活的韓國單品。品牌故事與正式素材仍待替換。" },
