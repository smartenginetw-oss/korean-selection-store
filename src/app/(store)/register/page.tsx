...
export default async function RegisterPage({ searchParams }: { searchParams: Promise<{ next?: string }> }) {
  ...
  return <div className={`container ${styles.page}`}>
    <div className={styles.frame}>
      <section className={styles.intro}><div className="eyebrow">Member file · GYEOT</div><h1 className="serif">建立你的<br />選品檔案。</h1><p>建立會員後，可以在 GYEOT 查看自己的訂單與配送資訊；不登入也仍然可以使用訪客結帳。</p></section>
